...
public class CustMnjOntBomRmlineLines {
    ...
    // For example, if there are relationships to other entities, use @OneToMany, @ManyToOne, etc.
}
...
public class CustMnjOntBomRmlineLinesController {
    ...
    @GetMapping
    public List<CustMnjOntBomRmlineLines> getAllLines() {
        return service.findAll();
    }

    @PostMapping
    public CustMnjOntBomRmlineLines createLine(@RequestBody CustMnjOntBomRmlineLines line) {
