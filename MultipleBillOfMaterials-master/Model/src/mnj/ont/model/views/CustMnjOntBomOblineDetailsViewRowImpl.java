...
public class CustMnjOntBomOblineDetails {
    ...
    public BigDecimal calculateTotalQty() {
        // Logic to calculate total quantity based on sizeQuantity
        // This is a placeholder for the actual calculation logic
        return sizeQuantity != null ? sizeQuantity.multiply(new BigDecimal(1)) : BigDecimal.ZERO;
    }
}
...
import com.example.mnj.model.CustMnjOntBomOblineDetails;
import com.example.mnj.service.CustMnjOntBomOblineDetailsService;
...
public class CustMnjOntBomOblineDetailsController {
    ...
    private final CustMnjOntBomOblineDetailsService service;

    @Autowired
    public CustMnjOntBomOblineDetailsController(CustMnjOntBomOblineDetailsService service) {
    ...
    @GetMapping("/{id}")
    public CustMnjOntBomOblineDetails getDetailById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public CustMnjOntBomOblineDetails updateDetail(@PathVariable Long id, @RequestBody CustMnjOntBomOblineDetails detail) {
...
import com.example.mnj.model.CustMnjOntBomOblineDetails;
import com.example.mnj.repository.CustMnjOntBomOblineDetailsRepository;
import org.springframework.beans.factory.annotation.Autowired;
...
public class CustMnjOntBomOblineDetailsService {
    ...
    @Autowired
    public CustMnjOntBomOblineDetailsService(CustMnjOntBomOblineDetailsRepository repository) {
    ...
    public CustMnjOntBomOblineDetails findById(Long id) {
    ...
    public CustMnjOntBomOblineDetails update(Long id, CustMnjOntBomOblineDetails detail) {
        detail.setId(id);
        return repository.save(detail);
    }
...
@Repository
public interface CustMnjOntBomOblineDetailsRepository extends JpaRepository<CustMnjOntBomOblineDetails, Long> {
}
...
public class MnjApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MnjApplication.class);
